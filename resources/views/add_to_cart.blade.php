		...
		<div class="container">
						...
						<tr class="table-row">
							...
							<td class="column-4">
								<div class="flex-w bo5 of-hidden w-size17">
									<a class="btn color1 flex-c-m size7 bg8 eff2" href="{{ URL::to('/dec_qty/'.$content->rowId,$content->qty) }}">
										<i class="fs-12 fa fa-minus" aria-hidden="true"></i>
									</a>

									<input class="size8 m-text18 t-center num-product" type="number" name="num-product2" value="{{ $content->qty }}">

									<a class="btn color1 flex-c-m size7 bg8 eff2" href="{{ URL::to('/inc_qty/'.$content->rowId,$content->qty) }}">
							...
							<a class="delete" href="{{ URL::to('/delete_cart_item/'.$content->rowId) }}">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-times" aria-hidden="true"></i></button>
                          </a>
			...
			<div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
				...
				<div class="size15 trans-0-4">
					<a class="checkout" href="{{ URL::to('/checkout') }}"></a>
					<!-- Button -->
